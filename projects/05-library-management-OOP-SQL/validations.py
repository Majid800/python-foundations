...
Provides reusable input validation functions used throughout
the application.

Handles text input, integer validation, positive number checks,
menu selections, and user confirmations. By centralising validation
logic in a single module, the application avoids duplicated code
and maintains consistent user input handling across all features.
"""
