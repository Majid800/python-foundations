...
Runs the library management system by displaying the main menu,
processing user selections, and coordinating the application's
core features.

Imports and coordinates the library management, statistics,
search, and validation modules to provide the command-line
interface.
"""
